...
import io.jackywacky.addon.utils.HotbarScreenutils;
...
public class BundleCrash extends Module {
    ...
    public BundleCrash() {
        super(DupersUnitedPublicAddon.CATEGORY_CRASHES, "bundle-crash", "Allows you to crash 1.21.4 servers with a bundle.");
    }
