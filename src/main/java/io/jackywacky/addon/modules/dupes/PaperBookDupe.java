...
import io.jackywacky.addon.utils.PacketUtils;
...
public class PaperBookDupe extends Module {
    ...
    public PaperBookDupe() {
        super(DupersUnitedPublicAddon.CATEGORY_DUPES, "book-dupe", "Dupes your inventory on Paper. Reconnect before duping to save your inventory. Only works on servers under 1.21.1");
