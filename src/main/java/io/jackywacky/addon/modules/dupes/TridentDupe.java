...
import io.jackywacky.addon.utils.timer.TickTimer;
...
public class TridentDupe extends Module {
    ...
    public TridentDupe() {
        super(DupersUnitedPublicAddon.CATEGORY_DUPES, "trident-dupe", "Works in 1.13 and above. Patched on Paper. Credit to Killet, Laztec & Ionar :3");
    }
